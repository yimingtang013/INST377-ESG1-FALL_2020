...
This is the lab support repository for the Fall 2020 version of INST377-ESG1. (Following in close collaboration with https://github.com/aleitch1) 
...
* Your labs should now be set up well enough for week one/two.
...
In your terminal window, in your copy of this repository (folder) - it should be called "INST377-ESG1-FALL_2020":
* type `git remote -v` - this will list all the remote places you can save your code.
    * It should list one: this repo, called "origin" - `origin https://github.com/bfarmerUMD/INST377-ESG1-FALL_2020`
...
```
classfiles https://github.com/bfarmerUMD/INST377-ESG1-FALL_2020.git (fetch)
classfiles https://github.com/bfarmerUMD/INST377-ESG1-FALL_2020.git (push)
...
* your local directory on your laptop - in finder or explorer - will be named INST377-ESG1-FALL_2020
...
* If you have to delete everything and re-clone, please `git remote add classfiles https://github.com/bfarmerUMD/INST377-ESG1-FALL_2020.git` so you can pull updates from the class repository.
